# from https://github.com/open-mmlab/mmdetection/blob/main/mmdet/models/seg_heads/panoptic_fusion_heads/maskformer_fusion_head.py
...
from mmdet.models.seg_heads.panoptic_fusion_heads import BasePanopticFusionHead
...
class MaskFormerFusionHead(BasePanopticFusionHead):
    ...
    def instance_postprocess(self, mask_cls: Tensor,
                             mask_pred: Tensor,
                             bbox_pred: Tensor = None) -> InstanceData:
        ...
        query_indices = torch.div(top_indices, self.num_classes, rounding_mode='trunc')
        ...
        # use predicted bbox directly if provided; otherwise use mask2bbox
    ...
    def predict(self,
        ...
        results = []
        for mask_cls_result, mask_pred_result, bbox_pred_result, meta in zip(
                mask_cls_results, mask_pred_results, bbox_pred_results, batch_img_metas):
            # remove padding
            ...
            if instance_on:
                ins_results = self.instance_postprocess(
                    mask_cls_result, mask_pred_result, bbox_pred_result)
